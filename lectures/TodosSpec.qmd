...
You are building a todo list application for a fictional client, "TaskFlow Inc." This assignment focuses on translating written specifications into functional interface designs. Your goal is to prompt and iterate with an AI tool until your design matches these specifications exactly.

## Client Background

TaskFlow Inc. needs a simple, clean todo list application for their users. They've provided specifications for an MVP consisting of two pages. As the designer/developer, you must create interfaces that meet these functional requirements. You have creative freedom on visual styling, but all specified functionality must be present.
